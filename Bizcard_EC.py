...
icon = Image.open("C:/Users/LENOVO/Downloads/imagess.png")
...
def app_background():
    st.markdown(f""" <style>.stApp {{
                            background: url("	https://img.freepik.com/free-vector/white-abstract…7e368eb33cf416b220786b28888e2861efccebe6a5e1b47b6");
        ...
        def normalize_data_lengths(data):
            ...
            for key in data.keys():
                if isinstance(data[key], list):
                    ...
                    # If the current length is less than max_length, add empty strings to make it equal
                    if current_length < max_length:
                        data[key].extend([''] * (max_length - current_length))
            
            return data
        # Normalize the data lengths
        normalized_data = normalize_data_lengths(data)
